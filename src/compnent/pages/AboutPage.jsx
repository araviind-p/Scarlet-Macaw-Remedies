      ...
      >
        ...
        >
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <motion.div
              className="bg-gradient-to-r from-blue-500 to-blue-600 text-white font-semibold py-2 px-6 rounded-full shadow-md cursor-pointer transform transition-transform hover:scale-105"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
            ...
            <motion.div
              className="bg-gradient-to-r from-green-500 to-green-600 text-white font-semibold py-2 px-6 rounded-full shadow-md cursor-pointer transform transition-transform hover:scale-105"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
            ...
            <motion.div
              className="bg-gradient-to-r from-red-500 to-red-600 text-white font-semibold py-2 px-6 rounded-full shadow-md cursor-pointer transform transition-transform hover:scale-105"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
